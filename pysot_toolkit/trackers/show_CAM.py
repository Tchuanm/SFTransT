...
def getCAM2(features, img, idx):
    ...
    #     os.makedirs(os.path.join('attention'))
    ...
    name = '/attention/attn_%d.png' % idx
    cv2.imwrite(os.path.dirname(__file__) + name, img)
...
def pltshow(pred_map, name):
    ...
    pred_name = os.path.dirname(__file__) + '/attention/' + str(name) + '.png'
