...
class Tracker(object):
    ...
    def __init__(self, name, net, instance_size=256, exemplar_size=128,
                 search_factor=4,  temp_factor=2, window_penalty=0.50, global_thr=0.9, fail_count=10):
        self.name = name
        self.net = net
    ...
    def track(self, image, global_flag, failure_num) -> dict:
        ...
        if score[best_idx] < self.global_thr:
            failure_num += 1
            global_flag = False
        ...
        out = {'target_bbox': bbox,
               'best_score': pscore}
        return out, global_flag, failure_num
