...
def create_default_local_file():
    ...
    default_settings = OrderedDict({
        ...
        'lasot_dir': 'self.workspace_dir + \'/../dataset/lasot\'',
        'got10k_dir': 'self.workspace_dir + \'/../dataset/got10k/train\'',
        'trackingnet_dir': 'self.workspace_dir + \'/../dataset/trackingnet\'',
        'coco_dir': 'self.workspace_dir + \'/../dataset/coco\'',
        'lvis_dir': empty_str,
        'sbd_dir': empty_str,
