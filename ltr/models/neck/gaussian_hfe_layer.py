...
def multi_head_attention_forward(
    ...
    attn_d = torch.ones(attn_output_weights.shape[-2:], device=attn_output_weights.device)/tgt_len
    attn_d = attn_d[None, None, ...]
    attn_h = attn_output_weights.view(bsz, num_heads, tgt_len, src_len) - attn_d
    attn_h = attn_h * (1. + lamb[None, :, None, None])
    attn_output_weights = (attn_d + attn_h).view(bsz*num_heads, tgt_len, src_len)
