...
from .gaussian_attention_layer import GaussianMultiheadAttention
from ltr.models.neck.misc import MLP


class NeckAugument(nn.Module):
    def __init__(self, d_model=256, nhead=8, iteration=4, iteration_smca=4, dim_feedforward=2048, dropout=0.1,
                 out_size=32, activation="relu", return_intermediate_dec=False, smooth=8, dynamic_scale='type3'):
        super().__init__()
...
def build_neck(settings):
    return NeckAugument(
        ...
        iteration_smca=settings.iteration_smca,
