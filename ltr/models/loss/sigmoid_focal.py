...
def sigmoid_focal_loss(inputs=None, targets=None, weight=None, num_boxes=None, alpha: float = 0.25, gamma: float = 2):
    """
...
def focal_loss(inputs, targets, weight, num_boxes, alpha: float = 0.25, gamma: float = 2):
