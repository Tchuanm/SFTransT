...
class BaseTrainer:
    ...
    def save_checkpoint(self):
        ...
        tmp_file_path = '{}/{}_ep{:d}.tmp'.format(directory, net_type, self.epoch)
        torch.save(state, tmp_file_path)

        file_path = '{}/{}_ep{:d}.pth.tar'.format(directory, net_type, self.epoch)
    ...
    def load_checkpoint(self, checkpoint = None, fields = None, ignore_fields = None, load_constructor = False):
        ...
        if checkpoint is None:
            ...
            checkpoint_path = '{}/{}/{}_ep{:03d}.pth.tar'.format(self._checkpoint_dir, self.settings.project_path,
                                                                 net_type, checkpoint)
